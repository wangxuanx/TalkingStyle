...
def trainer(args, train_loader, dev_loader, model, optimizer, criterion, epoch=100):
    ...
    for e in range(epoch+1):
        ...
        for i, (audio, vertice, template, one_hot, file_name) in pbar:
            ...
            loss, loss_detail = model(audio, template, vertice, one_hot, criterion, teacher_forcing=True)
            loss.backward()
        ...
        if (e > 0 and e % 10 == 0) or e == args.max_epoch:
...
def main():
    ...
    parser.add_argument("--max_epoch", type=int, default=00, help='number of epochs')
