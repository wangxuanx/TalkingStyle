    ...
    for e in range(epoch+1):
        ...
        for audio, vertice, template, one_hot_all,file_name in dev_loader:
            ...
            if train_subject in train_subjects_list:
                ...
                loss, loss_detail = model(audio, template, vertice, one_hot, criterion)
...
def main():
    ...
    parser.add_argument("--wav_path", type=str, default= "/workspace/CodeTalker_first_test/vocaset/wav", help='path of the audio signals')
    parser.add_argument("--vertices_path", type=str, default="/workspace/CodeTalker_first_test/vocaset/vertices_npy", help='path of the ground truth')
    ...
    parser.add_argument("--lip_region", type=str, default="vocaset/regions/lip.txt", help='path to the lip region')
