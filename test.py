...
def main():
    ...
    parser.add_argument("--save_path", type=str, default="save_best/models", help='path of the trained models')
    parser.add_argument("--result_path", type=str, default="save_best/result_b", help='path to the predictions')
